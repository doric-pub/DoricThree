...
export class GLTFView extends View {}

export class webgl_animation_keyframes extends Panel {
  private gestureView?: GestureContainer;

  onShow() {
    navbar(this.context).setTitle("webgl_animation_keyframes");
  }
    ...
    this.gestureView.addChild(
      dangleView({
        onReady: (gl: DangleWebGLRenderingContext) => {
          ...
          let requestAnimationFrame = vsync(this.context).requestAnimationFrame;
