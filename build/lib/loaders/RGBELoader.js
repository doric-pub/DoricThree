...
import { loge, resourceLoader } from "doric";
import { ClampToEdgeWrapping, DataTexture, DataUtils, FloatType, HalfFloatType, LinearEncoding, LinearFilter, } from "three";
...
export class RGBELoader {
    ...
    load(context, resource) {
        return __awaiter(this, void 0, void 0, function* () {
            const buffer = yield resourceLoader(context).load(resource);
