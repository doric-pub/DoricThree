...
declare class GLTFParser {
     ...
     */
    loadAccessor(accessorIndex: any): Promise<null> | Promise<BufferAttribute | InterleavedBufferAttribute>;
    /**
     ...
     */
    loadMesh(meshIndex: any): Promise<Group | SkinnedMesh<any, any> | Mesh<any, any> | LineSegments<any, any> | Line<any, any> | LineLoop<any, any> | Points<any, any>>;
    /**
